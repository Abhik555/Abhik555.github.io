...
export function ProjectCard() {
  ...
  return (
    <Card className="w-full max-w-sm border-none p-0 shadow-none m-1">
      <MagicCard
        // mode="orb"
        // glowFrom={isDark ? "#1d4ed8" : "#bfdbfe"}
        // glowTo={isDark ? "#06b6d4" : "#bae6fd"}
        gradientColor={theme === "dark" ? "#1d4ed820" : "#dbeafe80"}
        className="p-0"
      >
